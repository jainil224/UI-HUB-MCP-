...
export const get_dependencies = createTool('get_dependencies', 'Return the dependencies required by a specific UI HUB component. Premium components require a Pro subscription.', z.object({
