...
export const search_animations = createTool('search_animations', 'Search UI HUB animation resources (text, scroll, and effect animations). Premium animations are hidden completely for free-tier keys.', z.object({
    ...
    let results = componentService.searchAnimations(args);
...
//# sourceMappingURL=searchAnimations.js.map