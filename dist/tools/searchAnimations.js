...
export const search_animations = createTool('search_animations', 'Search UI HUB animation resources (text, scroll, and effect animations).', z.object({
    ...
    const results = componentService.searchAnimations(args);
