...
export const list_categories = createTool('list_categories', 'Return all available UI HUB component categories with counts.', z.object({}), { requiresPremium: false }, async (args, user) => {
