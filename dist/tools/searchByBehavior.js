...
export const search_by_behavior = createTool('search_by_behavior', 'Search UI HUB components by visual BEHAVIOR or vibe descriptions (e.g. "magnetic pull", "scroll reveal parallax", "accretion disk", "glow on hover"). Matches behavior descriptions, requirements, and AI vibe prompts. Premium components are hidden completely for free-tier keys.', z.object({
