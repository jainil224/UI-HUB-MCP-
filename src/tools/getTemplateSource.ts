...
export const get_template_source = createTool(
  'get_template_source',
  'Return the full source code and metadata for a complete website template from the UI HUB catalog (e.g. "tars-protocol", "sui-overflow"). Requires a UI HUB Pro subscription.',
  z.object({
