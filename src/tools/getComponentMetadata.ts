...
export const get_component_metadata = createTool(
  ...
  'Return rich metadata (props, behavior/vibe description, CSS properties, requirements) for a UI HUB component. Useful for accurately reproducing or integrating a component.',
  z.object({
